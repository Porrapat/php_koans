...
class AboutClassMethod extends TestCase
{
    ...
    {
        $this->assertEquals(5, self::my_global_method(2, 3));
    }
    ...
    {
        $this->assertEquals([1, 'default_value'], self::method_with_defaults(1));
        $this->assertEquals([1, 2], self::method_with_defaults(1, 2));
    }
    ...
    {
        $this->assertEquals('array', gettype(self::method_with_var_args()));
        $this->assertEquals([], self::method_with_var_args());
        $this->assertEquals(['one'], self::method_with_var_args('one'));
        $this->assertEquals(['one','two'], self::method_with_var_args('one', 'two'));
    }
    ...
    {
        $this->assertEquals('return_value', self::method_with_explicit_return());
    }
    ...
    {
        $this->assertEquals('return_value', self::method_without_explicit_return());
    }
    ...
    {
        $this->assertEquals(12, $this->my_method_in_the_same_class(3, 4));
    }
    ...
    {
        $this->assertEquals('a secret', $this->my_private_method());
    }
    ...
    {
        $rover = new Dog();
        $this->assertEquals('Fido', $rover->name());
    }
}
